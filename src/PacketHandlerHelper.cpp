...
void PacketHandlerHelper::onChat(const std::string &strMessage) { MASS_EVENT(onChat, strMessage) }
...
void PacketHandlerHelper::onPluginMessage(const std::string &strChannel, short iLength) { MASS_EVENT(onPluginMessage, strChannel, iLength) }
void PacketHandlerHelper::onKick(const std::string &strMessage) { MASS_EVENT(onKick, strMessage) }
...
void PacketHandlerHelper::onNamedEntitySpawn(int iEntity, const std::string &strName, int iX, int iY, int iZ, char cRot, char cPitch, short iItem) { MASS_EVENT(onNamedEntitySpawn, iEntity, strName, iX, iY, iZ, cRot, cPitch, iItem) }
...
void PacketHandlerHelper::onOpenWindow(unsigned char ucWindow, unsigned char ucType, const std::string &strTitle, unsigned char ucNumSlots) { MASS_EVENT(onOpenWindow, ucWindow, ucType, strTitle, ucNumSlots) }
void PacketHandlerHelper::onPacket01(int iEntity, const std::string &strUnused, __int64 iSeed, const std::string &strLevelType, int iMode, unsigned char ucDimension, unsigned char ucDifficulty, unsigned char ucHeight, unsigned char ucMaxPlayers) { MASS_EVENT(onPacket01, iEntity, strUnused, iSeed, strLevelType, iMode, ucDimension, ucDifficulty, ucHeight, ucMaxPlayers) }
void PacketHandlerHelper::onHandshake(const std::string &strHashOrUsername) { MASS_EVENT(onHandshake, strHashOrUsername) }
void PacketHandlerHelper::onPainting(int iEntity, const std::string &strTitle, int iX, int iY, int iZ, int iDirection) { MASS_EVENT(onPainting, iEntity, strTitle, iX, iY, iZ, iDirection) }
...
void PacketHandlerHelper::onPlayerListItem(const std::string &strName, bool bOnline, short iPing) { MASS_EVENT(onPlayerListItem, strName, bOnline, iPing) }
...
void PacketHandlerHelper::onRespawn(unsigned char ucDimension, unsigned char ucDifficulty, bool bCreative, short iMaxHeight, __int64 iSeed, const std::string &strLevelType) { MASS_EVENT(onRespawn, ucDimension, ucDifficulty, bCreative, iMaxHeight, iSeed, strLevelType) }
...
void PacketHandlerHelper::onUpdateSign(int iX, short iY, int iZ, const std::string &strLine1, const std::string &strLine2, const std::string &strLine3, const std::string &strLine4) { MASS_EVENT(onUpdateSign, iX, iY, iZ, strLine1, strLine2, strLine3, strLine4) }
