...
public:
	...
	void onPluginMessage(const std::string &strChannel, short iLength);
	...
	void onNamedEntitySpawn(int iEntity, const std::string &strName, int iX, int iY, int iZ, char cRot, char cPitch, short iItem);
	void onNewInvalidState(unsigned char ucReason, unsigned char ucGamemode);
	void onOpenWindow(unsigned char ucWindow, unsigned char ucType, const std::string &strTitle, unsigned char ucNumSlots);
	void onPacket01(int iEntity, const std::string &strUnused, __int64 iSeed, const std::string &strLevelType, int iMode, unsigned char ucDimension, unsigned char ucDifficulty, unsigned char ucHeight, unsigned char ucMaxPlayers);
	void onHandshake(const std::string &strHash);
	void onPainting(int iEntity, const std::string &strTitle, int iX, int iY, int iZ, int iDirection);
	...
	void onPlayerListItem(const std::string &strName, bool bOnline, short iPing);
	...
	void onRespawn(unsigned char ucDimension, unsigned char ucDifficulty, bool bCreative, short iMaxHeight, __int64 iSeed, const std::string &strLevelType);
	...
	void onUpdateSign(int iX, short iY, int iZ, const std::string &strLine1, const std::string &strLine2, const std::string &strLine3, const std::string &strLine4);
